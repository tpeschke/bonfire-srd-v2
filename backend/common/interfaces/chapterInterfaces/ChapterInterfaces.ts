...
type uniqueItemTables = 'uniqueItemCategories' | 'academicTools' | 'adventuringGear' | 'alchemicalSubstances' | 'tableToDetermineArmor' | 'lightArmor' | 'mediumArmor' | 'heavyArmor' | 'beveragesUniqueItems' | 'tableToDetermineClothing' | 'accessories' | 'body' | 'footgear' | 'headgear' | 'entertainment' | 'fabricsNRopes' | 'tableToDetermineFood' | 'preppedFood' | 'bread' | 'fruitsNVeggies' | 'protein' | 'nuts' | 'spicesNSeasonings' | 'householdItems' | 'illumination' | 'jewelry' | 'medical' | 'instruments' | 'personalContainers' | 'rawGoods' | 'religiousItems' | 'shieldsUniqueItems'
