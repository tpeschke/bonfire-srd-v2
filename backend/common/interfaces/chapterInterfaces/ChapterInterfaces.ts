...
type uniqueItemTables = 'uniqueItemCategories' | 'academicTools' | 'adventuringGear' | 'alchemicalSubstances' | 'tableToDetermineArmor' | 'lightArmor' | 'mediumArmor' | 'heavyArmor' | 'beveragesUniqueItems'
