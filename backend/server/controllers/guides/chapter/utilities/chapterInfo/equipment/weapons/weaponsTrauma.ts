...
export const weaponsTrauma: EquipmentItem[] = [
    ...
    { item: 'Goedendag', size: 'L', complexity: 3, basePrice: 24 },
    { item: 'Great Hammer', size: 'H', complexity: 5, basePrice: 200 },
    { item: "Peasant's Flail", size: 'L', complexity: 2, basePrice: 20 },
    { item: 'Quarterstaff', size: 'L', complexity: 1, basePrice: 8 },
    { item: 'War Flail', size: 'M', complexity: 4, basePrice: 50 },
