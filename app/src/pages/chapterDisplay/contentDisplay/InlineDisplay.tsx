...
export default function InlineDisplay({ componentInfo, chapterInfo }: Props) {
    switch (componentInfo.component) {
        ...
        case 'commonCloth':
            return <Table table={chapterInfo ? chapterInfo.info[1][0] : []} />
        case 'uncommonCloth':
            return <Table table={chapterInfo ? chapterInfo.info[1][1] : []} />
        case 'rareCloth':
            return <Table table={chapterInfo ? chapterInfo.info[1][2] : []} />
        case 'commonFurOrLeather':
            return <Table table={chapterInfo ? chapterInfo.info[1][3] : []} />
        case 'uncommonFurOrLeather':
            return <Table table={chapterInfo ? chapterInfo.info[1][4] : []} />
        case 'rareFurOrLeather':
            return <Table table={chapterInfo ? chapterInfo.info[1][5] : []} />
        case 'commonMetal':
            return <Table table={chapterInfo ? chapterInfo.info[1][6] : []} />
        case 'uncommonMetal':
            return <Table table={chapterInfo ? chapterInfo.info[1][7] : []} />
        case 'rareMetal':
            return <Table table={chapterInfo ? chapterInfo.info[1][8] : []} />
        case 'commonPaperProducts':
            return <Table table={chapterInfo ? chapterInfo.info[1][9] : []} />
        case 'uncommonPaperProducts':
            return <Table table={chapterInfo ? chapterInfo.info[1][10] : []} />
        case 'rarePaperProducts':
            return <Table table={chapterInfo ? chapterInfo.info[1][11] : []} />
        case 'commonStone':
            return <Table table={chapterInfo ? chapterInfo.info[1][12] : []} />
        case 'uncommonStone':
            return <Table table={chapterInfo ? chapterInfo.info[1][13] : []} />
        case 'rareStone':
            return <Table table={chapterInfo ? chapterInfo.info[1][14] : []} />
        case 'commonWax':
            return <Table table={chapterInfo ? chapterInfo.info[1][15] : []} />
        case 'uncommonWax':
            return <Table table={chapterInfo ? chapterInfo.info[1][16] : []} />
        case 'rareWax':
            return <Table table={chapterInfo ? chapterInfo.info[1][17] : []} />
        case 'commonWood':
            return <Table table={chapterInfo ? chapterInfo.info[1][18] : []} />
        case 'uncommonWood':
